...
T = {
    "es": {
        ...
        "dsp_seo_intro": "¿Buscas hacer trading con inteligencia artificial o necesitas una predicción de precio de mercado antes de operar? DSprofeta es una herramienta de análisis técnico con IA que combina Machine Learning, RSI, MACD y Fibonacci para predecir NASDAQ 100, Oro, EUR/USD y S&P 500 — y muestra qué tan confiable fue cada predicción anterior.",
    ...
    "en": {
        ...
        "dsp_seo_intro": "Looking to trade with artificial intelligence or need a market price prediction before you trade? DSprophecy is an AI technical analysis tool that combines Machine Learning, RSI, MACD and Fibonacci to predict NASDAQ 100, Gold, EUR/USD and S&P 500 — and shows you how reliable each past prediction actually was.",
